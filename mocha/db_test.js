...
//////////////////////////////////////////////////////////////////////////////
	it('should have a `cashPayment` property', function () {
    expect(Test.User.schema.paths.cashPayment).to.exist;
  });
   it('should have a `cashPayment` property that is a string', function () {
     expect(Test.User.schema.paths.cashPayment.options.type.name).to.equal('String');
  });
//////////////////////////////////////////////////////////////////////////////
	it('should have a `creditCardPayment` property', function () {
    expect(Test.User.schema.paths.creditCardPayment).to.exist;
  });
   it('should have a `creditCardPayment` property that is a string', function () {
     expect(Test.User.schema.paths.creditCardPayment.options.type.name).to.equal('String');
  });
///////////////////////////////////////////////////////////////////////////////
	it('should have a `bakerUser` property', function () {
    expect(Test.User.schema.paths.bakerUser).to.exist;
  });
   it('should have a `bakerUser` property that is a string', function () {
     expect(Test.User.schema.paths.bakerUser.options.type.name).to.equal('String');
  });
///////////////////////////////////////////////////////////////////////////////
	it('should have a `customerUser` property', function () {
    expect(Test.User.schema.paths.customerUser).to.exist;
  });
   it('should have a `customerUser` property that is a string', function () {
     expect(Test.User.schema.paths.customerUser.options.type.name).to.equal('String');
  });
///////////////////////////////////////////////////////////////////////////////
